...
<div class="card">
    <div class="card-header pb-0">
        <div class="d-flex align-items-center">
            <h6>Editing deck</h6>
            <a class="btn btn-primary btn-sm ms-auto" href="/addToDeck?id_deck=<?php echo "$params->id_deck"?>">Add</a>
        </div>
    </div>
        ...
        <div class="table-responsive p-0">
            <table class="table align-items-center mb-0">
                ...
                foreach ($params->cards as $param) {
                    ...
                    echo "<a href='/removeCardFromDeck?id_card=$param[id]&id_deck=$params->id_deck' class='text-secondary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Edit card'>";
                    echo "Remove";
                    echo "</a>";
                    echo " </td>";
                    echo "  </tr>";
